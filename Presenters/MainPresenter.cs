...
namespace Carriage_SMS_Project.Presenters
{
    public class MainPresenter
    {
        ...
        public MainPresenter(IMainView view)
        {
            ...
            _mainView.ShowOpcListView += (sender, e) => _mainView.ShowView(new OpcListView());
            ...
            _mainView.ShowRealtimeView += (sender, e) => _mainView.ShowView(new MonitoringView());


            _mainView.ExitApplication += (sender, e) => Application.Exit(); //단순 클릭으로 나가기
        }
